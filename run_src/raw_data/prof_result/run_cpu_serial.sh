...
PYTHON_FILE=/home/jwlee/transformers/cpu_profiler.py
#PYTHON_FILE=/home/jwlee/transformers/pim_profiler.py
# PYTHON_FILE=/home/jwlee/ort-project/onnxruntime/python/tools/transformers/pim_profiler.py
...
if [[ "${s}" ]]; then
    ...
    cmd="python3 ${PYTHON_FILE} --model ${MODEL} --batch_size 1 --sequence_length ${s} --samples 1 --thread_num 1 --basic_optimization --kernel_time_only --use_pim &> cpu_${s}.log"
    eval $cmd
    cd -
else
	FILE_DIR=${m}
