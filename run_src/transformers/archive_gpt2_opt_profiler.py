...
def run(args):
    ...
    # dnn_partition = json.loads("dnn_partition.json")
    # cpu_thread_map = json.loads("cpu_thread_map.json")

    dnn_partition_path = "./dnn_partition.json"
    cpu_thread_map_path = "./cpu_thread_map.json"

    with open(dnn_partition_path, 'r') as j:
        dnn_partition = json.loads(j.read())

    with open(cpu_thread_map_path, 'r') as j:
        cpu_thread_map = json.loads(j.read())
