...
# # roberta
cpu_profile_file = './roberta/cpu_roberta.json'
pim_profile_file = './roberta/pim_roberta.json'

#bert
#cpu_profile_file = './bert/cpu_bert.json'
#pim_profile_file = './bert/pim_bert.json'
